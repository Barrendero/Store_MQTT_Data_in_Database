...
MQTT_Topic_Oxygen = "Home/BedRoom/ud/Oxygen"
...
def publish_Fake_Sensor_Values_to_MQTT():
	...
	if toggle == 2:
		Oxygen_Fake_Value = float("{0:.2f}".format(random.uniform(10, 20)))

		Oxygen_Data = {}
		#Udself_Data['Sensor_ID'] = "Dummy-3"
		#Udself_Data['Date'] = (datetime.today()).strftime("%d-%b-%Y %H:%M:%S:%f")
		Oxygen_Data['Oxygen'] = Oxygen_Fake_Value
		Oxygen_json_data = json.dumps(Oxygen_Data)

		print ("Publishing fake Oxygen Value: " + str(Oxygen_Fake_Value) + "...")
		publish_To_Topic (MQTT_Topic_Oxygen, Oxygen_json_data)
		toggle = 0
